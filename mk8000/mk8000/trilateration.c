...
struct num
{
    int anc_ID;
    int distance;
}valid_anc_num[(MAX_ANC_NUM+1)]; //��Ϊ��8���� ���Դ�0��8 �����С����9

int cmp(const void *m,const void *n) //���巵��ֵ���ط�ʽ
{
...
/*
*��ǩ������㺯��demo
*�ӿں���GetLocation(&report, &anchorArray[0], &Range_deca[0]);
*��һ������reportΪ������
*�ڶ�������anchorArrayΪ��վ����3-8�����û�����λ�������ֶ�����
*����������Range_decaΪ����ֵ��4-8����ͨ���������ݽ����õ�
*/
int GetLocation(vec3d *best_solution, vec3d* anchorArray, int *distanceArray)
{
    ...
    for(int i=0;i<(MAX_ANC_NUM+1);i++)//��սṹ������
    {
        valid_anc_num[i].anc_ID=0;
        valid_anc_num[i].distance=0;
    }

    for(int i=0;i<MAX_ANC_NUM;i++)//��֤������Ч����ֵ
    {
        if(distanceArray[i]>0)
        {
            valid_anc_count++;
            valid_anc_num[j].anc_ID=i;//��¼��Ч��վ���
            valid_anc_num[j].distance=distanceArray[i];//��¼��Ч��վ����
            j++;
        }
    }
    ...
    else if(valid_anc_count==3)//ֱ��ִ������վ��λ
    {
        use3anc=1;
        /* Anchors coordinate */
    ...
    else if(valid_anc_count==4)//ֱ��ִ��4��վ��λ
    {
        /* Anchors coordinate */
        p1.x = anchorArray[valid_anc_num[0].anc_ID].x;		p1.y = anchorArray[valid_anc_num[0].anc_ID].y;	    p1.z = anchorArray[valid_anc_num[0].anc_ID].z;
        p2.x = anchorArray[valid_anc_num[1].anc_ID].x;		p2.y = anchorArray[valid_anc_num[1].anc_ID].y;	    p2.z = anchorArray[valid_anc_num[1].anc_ID].z;
    ...
    //valid_anc_count ��Ч��վ����
    //valid_anc_num[0] ��Ч��վ���
    else if(valid_anc_count>4)//ִ�л�վѡȡ���ƣ�ѡȡ�����4����վ1234���м���
    {
         qsort(valid_anc_num, (valid_anc_count+1), sizeof(valid_anc_num[0]), cmp);  //����Ч����ֵ���д�С��������
         for(int i=1;i<=valid_anc_count;i++) //������
    ...
    if((result==0)&&(valid_anc_count>4))//����4��վѡȡ�����ʧ�ܣ��ѵ�1����õ�2345����
    {

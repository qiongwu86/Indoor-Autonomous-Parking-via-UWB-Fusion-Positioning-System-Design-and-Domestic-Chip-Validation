...
def plt_all(date):
    ...
    plt.title(f'Location', fontsize=17)
    ...
    plt.legend(loc='lower left', fontsize=17, framealpha=0.9)
    ...
    ax_inset = inset_axes(ax_main,
                        ...
                        # width="1%",     # 宽度占主图的百分比
                        # height="1%",    # 高度占主图的百分比
                        bbox_to_anchor=(0.6, 0.0, 1.0, 1.0),  # (x0, y0, width, height)            # 框图坐标
